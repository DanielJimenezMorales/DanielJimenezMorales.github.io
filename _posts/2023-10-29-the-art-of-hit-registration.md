...
{: .box-note}**Note:** As previously mentioned in the **Server-side rewind** section, Conditional Lag Compensation can also act as a limitation for cheaters trying to manipulate the client's input timestamp significantly as it will be clamped anyway.
